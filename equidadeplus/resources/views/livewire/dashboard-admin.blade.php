    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Visão geral de todas as unidades e atividades do sistema</p>
            </div>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">{{ $totalUnidades }}</p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">{{ $totalProfissionais }}</p>
                        </div>
                        <div class="bg-white/20 rounded-full p-3">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">{{ $totalAtendimentosMes }}</p>
                        </div>
                        <div class="bg-white/20 rounded-full p-3">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($produtividadePorUnidade->isNotEmpty())
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 mb-6">
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Produtividade por Unidade (Últimos 30 dias)</h2>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        @foreach($produtividadePorUnidade as $item)
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0">
                                        <div class="h-10 w-10 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center text-white font-semibold">
                                            {{ strtoupper(substr($item['unidade']->nome, 0, 1)) }}
                                        </div>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">{{ $item['unidade']->nome }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-lg font-bold text-gray-900">{{ $item['atendimentos'] }}</p>
                ...
                <a href="{{ route('app.colaboradores') }}" 
                   class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 p-6 hover:shadow-lg transition">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-gray-900">Colaboradores</h3>
                            <p class="text-xs text-gray-500 mt-1">Gerenciar usuários</p>
                        </div>
                    </div>
                </a>
