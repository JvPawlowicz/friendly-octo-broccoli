            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 mb-2">Minhas Avaliações</h1>
                            <p class="text-gray-600">Visualize e gerencie todas as suas avaliações aplicadas</p>
                        </div>
                ...
                <div class="p-6">
                    @if($avaliacoes->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Comece aplicando uma nova avaliação.</p>
                        </div>
                    @else
                        <div class="space-y-4">
